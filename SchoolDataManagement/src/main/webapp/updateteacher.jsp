            ...
            <div class="user-details">
              <div class="input-box">
                  ...
                  <div class="input-box">
                    ...
                    <input type="text"  id="num" required placeholder="enter your Id number" name="cont">
                </div>
               
                  <div class="input-box">
                    <label for="">ClassTeacher</label>
                    <input type="text"  id="contact" required placeholder="enter your  contact numbre" name="clatech">
                </div>
                  <div class="input-box">
                    <label for="">Salary</label>
                    <input type="text"  id="address" required placeholder="enter your Address" name="sal">
                </div>
         
                   <div class="input-box">
                        <label for="">Address</label>
                        <input type="text"  id="uname" required placeholder="enter your Email"  name="add">
                </div>
